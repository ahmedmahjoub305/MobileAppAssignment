...
public class ContractorRegister extends AppCompatActivity {
    ...
    private EditText editTextFirstName, editTextLastName, editTextAge, editTextGender, editTextEmail, editTextPassword,Speciality,Experience;
    ...
    public void registerUser(View view) {
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                ref.child(String.valueOf(maxId + 1)).child("speciality").setValue(SpecialityStr);
                ref.child(String.valueOf(maxId + 1)).child("experience").setValue(ExperienceStr);
                ref.child(String.valueOf(maxId + 1)).child("SignInAs").setValue("Contractor");
